                ...
                <div class="flex flex-col md:flex-row gap-4 w-full md:w-auto">
                    <div class="relative w-full md:w-64">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}"
                            ...
                            placeholder="Search brand..." onkeydown="if(event.key === 'Enter') this.form.submit()">
                    </div>
                    ...
                    @if (request()->filled('search') || (request()->has('status') && request('status') !== ''))
                        <a href="{{ route('admin.brands') }}"
                            class="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-600 bg-gray-100 rounded-lg hover:bg-gray-200 hover:text-gray-800 transition duration-200">
                    ...
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                <h3 class="text-lg font-semibold leading-6 text-gray-900" id="modal-title">Delete Brand
                                </h3>
                                <div class="mt-2">
